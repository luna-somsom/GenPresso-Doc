...
export const outpaintingContentKo: JSX.Element = (
  <div className="space-y-8">
    <div>
      <p className="text-lg text-muted-foreground leading-relaxed mb-8">
        아웃페인팅 기능에 대한 자세한 가이드를 준비하고 있습니다.
      </p>
    </div>
    ...
    <div className="flex flex-col items-center justify-center py-16 px-6 border border-dashed border-purple-300 dark:border-purple-700 rounded-2xl bg-gradient-to-br from-purple-50/50 to-violet-50/50 dark:from-purple-950/20 dark:to-violet-950/20">
      ...
      <p className="text-base text-muted-foreground text-center max-w-md">아웃페인팅 기능에 대한 자세한 가이드는 곧 제공될 예정입니다.</p>
    </div>
  </div>
)

export const outpaintingContentEn: JSX.Element = (
  <div className="space-y-8">
    <div>
      <p className="text-lg text-muted-foreground leading-relaxed mb-8">
        We're preparing detailed guides for the outpainting feature.
      </p>
    </div>
    ...
    <div className="flex flex-col items-center justify-center py-16 px-6 border border-dashed border-purple-300 dark:border-purple-700 rounded-2xl bg-gradient-to-br from-purple-50/50 to-violet-50/50 dark:from-purple-950/20 dark:to-violet-950/20">
      ...
      <p className="text-base text-muted-foreground text-center max-w-md">Detailed guides for the outpainting feature will be available soon.</p>
    </div>
  </div>
)
